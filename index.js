...
$("#banditFight").click(function(){
    ...
    }else{let diceRoll = Math.random() * 3;
         if(diceRoll < 1){
...
$("#room3").click(function(){let diceRoll = Math.random() * 8;
if (diceRoll < 1) {
    alert("You enter the next room and theres a empty doorway in the middle of it.");
    menu = switchMenu("dungeon4");
} else if (diceRoll < 2) 
...
$("#room4").click(function(){let diceRoll = Math.random() * 8;
if (diceRoll < 1) {
    alert("You enter the next room and theres a empty doorway in the middle of it.");
    menu = switchMenu("dungeon4");
} else if (diceRoll < 2) 
...
$("#room5").click(function(){let diceRoll = Math.random() * 8;
if (diceRoll < 1) {
...
$("#room6").click(function(){let diceRoll = Math.random() * 8;
if (diceRoll < 1) {
    alert("You enter the next room and theres an empty doorway in the middle of it.");
    menu = switchMenu("dungeon4");
} else if (diceRoll < 2) 
...
$("#moveRoom").click(function(){let diceRoll = Math.random() * 3;
if (diceRoll < 1) {
...
$("#moveRoom2").click(function(){let diceRoll = Math.random() * 4;
if (diceRoll < 1) {
...
if(shield >= 1) {
    alert("You walk through the room and hear a click and a barrage of arrows fire at you but you protect yourself with your shield!");
    let diceRoll = Math.random() * 3;
    if (diceRoll < 1) {
        alert("You enter the next room and theres a chest and what appears to be an exit.");
        menu = switchMenu("dungeonEnd");
...
$("#moveRoom3").click(function(){let diceRoll = Math.random() * 3;
if (diceRoll < 1) {
...
$("#moveRoom4").click(function(){let diceRoll = Math.random() * 3;
    if (diceRoll < 1) {
